...
/*
 Code points can be between 0x0 and 0x10FFFF in hexadecimal or between 0 and 1114111 in decimal
 As such unicode code points can be represented by 21 bits.
